...
folder='G:\My Drive\Exp_data_new\file_backup';
...
pinArray1 = [1,2,3,4];
pinArray2 = [5,6,7];
[tfb_MU2,VfbPinAve_diff_40C,VfbStd_tot_40C]=FittingVfb_extendedappV8(filepath_MU2,2,pinArray1,pinArray2,'save_figures');
...
figure
errorbar(tfb_MU1./3600,VfbPinAve_diff_30C,VfbStd_tot_30C,'Marker','s','LineWidth',2,'MarkerSize',10);
hold on
errorbar(tfb_MU2./3600,VfbPinAve_diff_40C,VfbStd_tot_40C,'Marker','s','LineWidth',2,'MarkerSize',10);
hold on
errorbar(tfb_MU3./3600,VfbPinAve_diff_50C,VfbStd_tot_50C,'Marker','s','LineWidth',2,'MarkerSize',10);
xlabel('Time (hours)');
ylabel('Vfb shift (V)');
