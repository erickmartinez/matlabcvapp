function [success] = setHotPlateTemperature(app,hotplateNumber,...
...
%   1 if ok, 0 otherwise
    ...
    if (currentSetPoint ~= temperature || ...
        ...
        try
            ...
            if (isempty(out) || out(3) == 1)  %If no response or error
                ...
                if failedCalls <= MAX_FAILED_CALLS
                    ...
                    success = setHotPlateTemperature(app,hotplateNumber,...
                        temperature,failedCalls);
                else
        ...
        if getHotPlateTemperatureStatus(app,hotplateNumber) == 1
            ...
            success = setHotPlateTemperature(app,hotplateNumber,temperature);
        end
